...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	std::u8string path{ u8"c:\\Windows\\Fonts\\meiryo.ttc" };
	io.Fonts->AddFontFromFileTTF(std::string{ path.begin(), path.end() }.c_str(), 18.0f, nullptr, io.Fonts->GetGlyphRangesJapanese());	ImGui_ImplDXlib_Init();
#endif
	AppInit();
